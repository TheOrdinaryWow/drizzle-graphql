...
export type ExtractTableByName<TTableSchema extends Record<string, Table>, TName extends string> = {
  [K in keyof TTableSchema as TTableSchema[K]["_"]["name"] extends TName ? K : never]: TTableSchema[K]["_"]["name"] extends TName
    ? TTableSchema[K]
    : never;
};
...
export type SelectResolver<TTable extends Table, TTables extends Record<string, Table>, TRelations extends Record<string, Relation>> = (
  source: any,
...
export type GeneratedEntities<
  ...
  TOutputs extends GeneratedOutputs<TSchemaTables, TDatabase extends MySqlDatabase<any, any, any, any> ? true : false> = GeneratedOutputs<
    TSchemaTables,
