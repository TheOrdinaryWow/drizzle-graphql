...
import type { TableNamedRelations } from "../builders";
...
export const remapToGraphQLCore = (
  ...
  if (Array.isArray(value)) {
    ...
    if (relations?.[key]) {
      ...
      return remapToGraphQLArrayOutput(value, relations[key]!.targetTableName, relations[key]!.relation.referencedTable, relationMap);
    }
