...
export type ColTypeIsNull<TColumn extends Column, TColType> = TColumn["_"]["notNull"] extends true ? TColType : TColType | null;
...
export type GetRemappedTableDataType<TTable extends Table, TColumns extends TTable["_"]["columns"] = TTable["_"]["columns"]> = {
